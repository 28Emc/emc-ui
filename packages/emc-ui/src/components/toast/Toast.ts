...
export class EmcToast extends LitElement {
  ...
  render() {
    ...
    const iconMap = {
      default: html`<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
      ...
      success: html`<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="2"
      ...
      error: html`<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="2"
      ...
      warning: html`<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="2"
